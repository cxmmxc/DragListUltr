    ...
    public void setOnItemClickListener(final MotionEvent ev) {
        setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view,
                ...
                ImageView dragTheImageView = (ImageView) dragViewGroup.findViewById(R.id.drag_grid_img);
                int[] dragLocation = new int[2];
                dragTheImageView.getLocationOnScreen(dragLocation);
                Log.e("cxm", "x=" + x + ",y=" + y + "--dragLoa0=" + dragLocation[0] + ",dragLoa1=" + dragLocation[1] + ",view.getWidth=" + dragTheImageView.getWidth() + ",view.getHeight=" + dragTheImageView.getHeight());
                if (!((x > dragLocation[0] && x < dragLocation[0] + dragTheImageView.getWidth() && (y > dragLocation[1] && y < dragLocation[1] + dragTheImageView.getHeight())))) {
                    return false;
                }
